...
const SingupScreen = () => {
    ...
    const { userName, userEmail, userGender, userCalender, userMonth, userNakshathra } = dynamicState

    const signInHome = () => {

        setDynamicArray([...dynamicArray, { userName, userEmail, userGender, userCalender, userMonth, userNakshathra }])
        // context.globalFunction([...dynamicArray, dynamicState]);



        const URL = "http://localhost:4000/add/userprofile"
        ...
        const addUserForm = (impId) => {
            const URL = `http://localhost:4000/list/userprofile?userEmail=${dynamicState.userEmail}&userMonth=${dynamicState.userMonth}&userNakshathra=${dynamicState.userNakshathra}&userCalender=${dynamicState.userCalender}&impId=${impId}`;
        ...
        <div className="overall-container-profile">
            <div className="overall-percent-signup">
                <div className="signup-title">
                    <h1 className="letters-color-header">SIGN UP FOR YOUR JANMA DINAM REMINDER</h1>
                </div>
                <div className="signup-content">
                    <div className="signup-box">
                        <div className="title-profile">
                            <h2 className="letters-color-subhead1">Profile</h2>
                        </div>
                        ...
                        <div className="title-email">
                            ...
                            <div className="value-input">
                                <input className="singup-input-box" type="email" name="userEmail" placeholder="please enter user email" onChange={handleInput} />
                            </div>
                        </div>
