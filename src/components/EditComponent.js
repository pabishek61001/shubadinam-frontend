        ...
        <div className="edit-popup">
            ...
            <div className="edit-content">
                <div className="edit-form">
                    <div className="form-group">
                        <label htmlFor="relName" className="edit-keys edit-label">Name</label>
                        <input
                    ...
                    <div className="form-group">
                        <label htmlFor="relGender" className="edit-keys edit-label">Gender</label>
                        <select defaultValue={""} className="edit-input" name="editRGender" onChange={handleInput}>
                    ...
                    <div className="form-group">
                        <label htmlFor="relRelation" className="edit-keys edit-label">Relation</label>

                        <select defaultValue={""} className="edit-input" name="editRRelation" onChange={handleInput}>
                    ...
                    <div className="form-group">
                        <label htmlFor="relCelebrate" className="edit-keys edit-label">What do they celebrate</label>
                        <select defaultValue={""} className="edit-input" onChange={handleNakTithi} name="editRnakshatraTithi" >
                    ...
                    <div className="form-group" >
                        <label htmlFor="relPanchang" className="edit-keys edit-label">Panchang</label>
                        <select defaultValue={""} className="edit-input" onChange={handleCalender} name="editRCalender" >
                    ...
                    <div className="form-group">
                        <label htmlFor="relMonth" className="edit-keys edit-label">Month</label>
                        <select defaultValue={""} className="edit-input" onChange={handleMonth} name="editRMonth" >
...

                    {
                        nakTithi && nakTithi === "Nakshatra" ?
                            ...
                            <div className="form-group">
                                <label htmlFor="relNakshatra" className="edit-keys edit-label">Nakshatra</label>
                                {/* <div className="value-input"> */}
                                <select defaultValue={""} className="edit-input" onChange={handleNakshathra} name="editRrelNakshathra">
...

                    {
                        nakTithi && nakTithi === "Tithi" ?
                            <div className="nakandtithi">
                                <div className="form-group">
                                    <label htmlFor="relPaksham" className="edit-keys edit-label">Paksha</label>
                                    {/* <div className="value-input"> */}
                                    <select defaultValue={""} className="edit-input" onChange={handlePaksham} name="editRPaksham">
                                ...
                                <div className="form-group">
                                    <label htmlFor="relTithi" className="edit-keys edit-label">Tithi</label>
                                    {/* <div className="value-input"> */}
                                    <select defaultValue={""} className="edit-input" onChange={handleTithi} name="editRTithi">
            ...
            <div className="edit-buttons">
                <button className="edit-changes" onClick={handleSave} disabled={
                    ...
                    editRelState.editRnakshatraTithi === "" ||
                    editRelState.editRrelNakshathra === "" && editRelState.editRTithi === ""
