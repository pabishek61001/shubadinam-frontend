        ...
        <div className="container-header">
            ...
            <div className="container-1">
                ...
                <div className={`menu-bar-container ${isOpenMenu ? 'open' : ''}`}>
                    ...
                    {isOpenMenu && (
                        ...
                        <div className="menu-bar-cnt">
                            ...
                            <div className="menu-bar-items" data-aos="fade-up">
                                <NavLink to="/" className={({ isActive }) => isActive ? "menu-link hightlight-link" : "menu-link"}>Register</NavLink>
                            </div>
                ...
                <div className="wordpress" onContextMenu={(e) => e.preventDefault()}>
                    <img className="logo-fit-header" src={require("../images/Shubadinam White.png")} width="100%" height="100%" onClick={() => logoBtn()} />
                </div>
