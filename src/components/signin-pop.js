...
const SignInComponent = () => {
    ...
    const signInHome = () => {
        ...
        const addUserForm = (impId) => {
            const URL = `https://backend.shubadinam.com/list?userEmail=${dynamicState.userEmail}&userCalender=${dynamicState.userCalender}&userMonth=${dynamicState.userMonth}&nakshatraTithi=${dynamicState.nakshatraTithi}&userNakshathra=${dynamicState.userNakshathra}&userPaksham=${dynamicState.userPaksham}&userTithi=${dynamicState.userTithi}&impId=${impId}`;
                ...
                <div className="modal-dialog custom-modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5 add-btn" id="exampleModalLabel">Add Here</h1>
